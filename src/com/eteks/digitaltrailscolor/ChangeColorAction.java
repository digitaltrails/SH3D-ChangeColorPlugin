...
public class ChangeColorAction extends PluginAction {

	private final ChangeColorPlugin context;

	private ChangeColorUI userInterface;
	...
	@Override
	public void execute() {
		userInterface = new ChangeColorUI(context);
		userInterface.pack();
